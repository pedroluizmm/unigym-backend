...
const treinoExercicioRoutes = require('./src/routes/treinoExercicio.routes');
const historicoRoutes = require('./src/routes/historico.routes');
const conquistaRoutes = require('./src/routes/conquista.routes');
const usuarioConquistaRoutes = require('./src/routes/usuarioConquista.routes.js');
...
app.use("/api/usuario-conquistas", usuarioConquistaRoutes);
app.use('/api/treinoExercicio', treinoExercicioRoutes);
